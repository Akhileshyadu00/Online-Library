        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {books.length === 0 ? (
            <div className="col-span-full text-center">
              <p className="text-gray-900">No books in the library yet.</p>
            </div>
          ) : filtered.length === 0 ? (
            <div className="col-span-full text-center">
              <p className="text-gray-900">No matching books found for your search.</p>
            ...
            filtered.map((book) => (
              <div
                key={book.id}
                className="border border-gray-200 bg-white p-4 rounded-xl hover:shadow-md transition"
              >
